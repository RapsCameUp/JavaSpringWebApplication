		...
		<div class="container">
			<div class="row">
				<div class="col-lg-12 mt-5">
					<h5 class="float-start">Search Result</h5>
				</div>
				<hr />
			</div>
			...
			<form action="getuserByEmail" method="get">
				<div class="row mt-4">
					<div class="col-sm-3">
						<input type="email" class="form-control form-control-sm" placeholder="search user by email" required/>
					</div>
					<div class="col-sm-1">
						...
						<div class="card-body">
							<table class="table">
								...
								<tr>
											...
											<td> <c:out value="${requestScope.surname}" /></td>
											<td><c:out value="${requestScope.email}" /></td>
											<td><c:out value="${requestScope.role}" /></td>
								  ...
								  <a class="btn btn-sm btn-dark" href="getAllUsers">Back</a>
						</div>
					</div>
				</div>
			</div>
